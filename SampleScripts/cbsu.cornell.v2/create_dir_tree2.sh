...
ref="/workdir/lgao/wheat_docker2/DataFolders/reference/wheat_chr1A1B1D.fa"
intervals_file="/workdir/lgao/wheat_docker2/DataFolders/wheat1A1B1D.bed"
config_file="/workdir/lgao/wheat_docker2/DataFolders/configSQLite.txt"
ref_load_file="/workdir/lgao/wheat_docker2/DataFolders/wheat_load_data.txt"
